...
namespace ZtProject.DataAccess.Migrations
{
    ...
    [Migration("20230911141147_AddCardRequestToClient")]
    partial class AddCardRequestToClient
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZtProject.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OpeningDate = new DateTime(2023, 9, 11, 17, 11, 47, 533, DateTimeKind.Local).AddTicks(7889)
                        });
                });
